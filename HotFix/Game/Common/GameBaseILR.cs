...
public partial class GB : GameBase
{
	// FrameSystem
	...
	public override void notifyConstructDone()
	{
		...
		mGameConfig = mGameFramework.getSystem(typeof(GameConfig)) as GameConfig;
		mDemoSystem = mGameFramework.getSystem(typeof(DemoSystem)) as DemoSystem;
	}
