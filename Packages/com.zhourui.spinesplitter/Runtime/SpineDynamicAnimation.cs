...
public static class SpineDynamicAnimation
{
    ...
    public static bool hasAnimation(SkeletonGraphic skeletonGraphic, string animationName)
    {
        ...
        registerAnimationState(skeletonGraphic.Skeleton.Data, skeletonGraphic.AnimationState);
    ...
    {
        if (skeletonGraphic == null || skeletonGraphic.Skeleton == null || skeletonGraphic.Skeleton.Data == null || skeletonGraphic.AnimationState == null)
        {
            return false;
        }
        registerAnimationState(skeletonGraphic.Skeleton.Data, skeletonGraphic.AnimationState);
    ...
    public static bool unregisterAnimationState(SkeletonGraphic skeletonGraphic)
    {
        ...
        return unregisterAnimationState(skeletonGraphic.Skeleton.Data, skeletonGraphic.AnimationState);
    }
    ...
    public static TrackEntry playAnimation(SkeletonGraphic skeletonGraphic, int trackIndex, string animationName, bool isLoop)
    {
        ...
        TrackEntry entry = skeletonGraphic.AnimationState.SetAnimation(trackIndex, animation, isLoop);
        trimDynamicAnimations(skeletonGraphic.Skeleton.Data);
        return entry;
    }
    ...
    {
        if (skeletonGraphic == null || skeletonGraphic.Skeleton == null || skeletonGraphic.Skeleton.Data == null || skeletonGraphic.AnimationState == null || skeletonGraphic.skeletonDataAsset == null)
        {
