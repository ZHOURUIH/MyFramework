...
public class MenuInit
{
	...
	protected static void initHybridCLRObfuz()
	{
		...
		{
			obfuzChanged = true;
			Debug.Log("已设置Obfuz混淆程序集: " + string.Join(',', FrameSettings.getHotFixList()));
		}
		...
		addAsmdefToArray(ref HybridCLRSettings.Instance.hotUpdateAssemblyDefinitions, FrameSettings.getHotFixList().ToArray());
	...
	protected static void addAsmdefToArray(ref AssemblyDefinitionAsset[] array, params string[] asmdefNames)
	{
	...
	protected static bool setObfuzAssemblySettings()
	{
		...
		// 这里的顺序很重要,被依赖的需要在前面
		string[] newAssemblies = addStringToArray(oldAssemblies, FrameSettings.getHotFixList().ToArray());
