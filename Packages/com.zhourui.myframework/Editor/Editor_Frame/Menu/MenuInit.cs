...
public class MenuInit
{
    ...
    protected static void initHybridCLRObfuz()
    {
        ...
        ObfuzSettings.Instance.encryptionVMSettings.codeOutputPath = OBFUZ_OUTPUT_PATH;
        ObfuzSettings.Save();
        Debug.Log("已设置Obfuz生成文件路径: " + OBFUZ_OUTPUT_PATH);
#else
        Debug.LogWarning("未启用USE_OBFUZ宏,跳过Obfuz设置");
#endif
#if USE_HYBRID_CLR
        createDir(P_ASSETS_PATH + getFilePath(HYBRIDCLR_AOT_OUTPUT_PATH));
