...
// MovableObject 深度测试
// ============================================================================
// 与 MovableObjectTest(单接口调用) 的区别:
//   本测试聚焦移动信息组件(COMMovableObjectMoveInfo)的复杂时序行为——
//   真实驱动 update/fixedUpdate 推进, 验证速度/加速度/上一帧位置随帧演进的
//   涌现规律; 以及外部对象 setObject 与自建节点的生命周期切换、交互回调链、
//   可拖拽状态的转变。覆盖单接口测不到的调用链与状态过渡。
// ============================================================================
public static class MovableObjectDeepTest
{
