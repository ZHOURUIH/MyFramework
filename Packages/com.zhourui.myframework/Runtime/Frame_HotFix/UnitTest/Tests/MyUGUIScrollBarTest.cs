...
public static class MyUGUIScrollBarTest
{
	public static void Run()
	{
		...
		testSetGetValue_Deep();
		testCallbackChain_Deep();
		testCallbackReplace();
		testNoCallbackSafe();
	...
	// ═════════════════════════════════════════════════════════════════
	private static myUGUIScrollBar createScrollBar_Deep(out GameObject go)
	{
	...
	private static void testSetGetValue_Deep()
	{
		myUGUIScrollBar sb = createScrollBar_Deep(out GameObject go);
		try
		{
			sb.setValue(0.5f);
	...
	private static void testCallbackChain_Deep()
	{
		myUGUIScrollBar sb = createScrollBar_Deep(out GameObject go);
		try
		{
