...
// 跟UGUIProgress的区别在于这个的进度图片是一个序列帧
[CommonControl]
public class UGUIAnimProgress : WindowObjectUGUI, ISlider
{
	protected myUGUIImageAnim mProgressBar;			// 进度条中显示进度的窗口
	...
	public UGUIAnimProgress(IWindowObjectOwner parent) : base(parent){}
	...
	public myUGUIImageAnim getProgressBar() { return mProgressBar; }
