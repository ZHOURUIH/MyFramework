...
{
	protected byte[] mBuffer = null;	// 缓冲区
	protected int mBitIndex = 0;		// 当前写下标
	...
	{
		write(value.x, precision);
		write(value.y, precision);
	}
	...
	public void writeString(string str, Encoding encoding = null)
	{
		...
		int strLen = bytes != null ? bytes.Length : 0;
