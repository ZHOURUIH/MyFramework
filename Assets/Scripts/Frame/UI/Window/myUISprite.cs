...
public class myUISprite : myUIObject, IShaderWindow
{
	...
	public override void init()
	{
		...
		mSpriteRenderer = getUnityComponent<SpriteRenderer>();
		if (mSpriteRenderer == null)
		{
			logError(Typeof(this) + " can not find " + typeof(SpriteRenderer) + ", window:" + mName + ", layout:" + mLayout.getName());
		}
	...
	public override void destroy()
	{
		...
		{
#if !UNITY_EDITOR
			destroyGameObject(mSpriteRenderer.material);
#endif
		}
	...
	public int getRenderQueue(int renderQueue)
	{
		if (mSpriteRenderer == null || mSpriteRenderer.material == null)
		{
			return 0;
	...
	public virtual void setAtlas(UGUIAtlasPtr atlas, bool clearSprite = false)
	{
		...
		{
			setSprite(mAtlasPtr.getSprite(getSpriteName()));
		}
	}
	public void setSpriteName(string spriteName)
	{
		if (mSpriteRenderer == null || !mAtlasPtr.isValid())
		{
			return;
		}
	...
	public void setSpriteOnly(Sprite tex)
	{
		if (mSpriteRenderer == null)
		{
			return;
		}
		if (tex != null && !isFloatEqual(tex.pixelsPerUnit, 1.0f))
		{
			logError("sprite的pixelsPerUnit需要为1, name:" + tex.texture.name);
		}
		mSpriteRenderer.sprite = tex;
	}
	...
	public void setColor(Vector3 color)
	{
		...
		mSpriteRenderer.color = new Color(color.x, color.y, color.z);
	}
