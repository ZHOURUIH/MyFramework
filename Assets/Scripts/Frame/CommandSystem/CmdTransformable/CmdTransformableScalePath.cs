...
// 以指定的路径缩放一个物体
public class CmdTransformableScalePath : Command
{
	public Dictionary<float, Vector3> mValueKeyFrame;	// 缩放值和时间的关键帧列表
...
#endif
		obj.getComponent(out COMTransformableScalePath com);
