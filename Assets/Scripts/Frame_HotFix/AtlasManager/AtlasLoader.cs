...
// 从GameResources中加载TPSprite或者SpriteAtlas
public class AtlasLoader
{
	...
	public void update(float elapsedTime)
	{
		...
		{
			if (tickTimerLoop(ref mCheckTimer, elapsedTime, CHECK_INTERVAL))
			{
	...
	public AtlasRef getAtlas(string atlasName, bool errorIfNull, bool loadIfNull)
	{
	...
	public CustomAsyncOperation getAtlasAsyncSafe(IRecyclable owner, string atlasName, UGUIAtlasPtrCallback callback, bool errorInNull, bool loadIfNull)
	{
	...
	public static AtlasBase atlasLoaded<T>(T[] assets, ResourceRef<UObject> mainAsset, string loadPath) where T : UObject
	{
		if (assets.isEmpty())
		{
			return null;
