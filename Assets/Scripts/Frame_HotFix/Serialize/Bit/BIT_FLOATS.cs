...
public class BIT_FLOATS : SerializableBit
{
	...
	public static implicit operator List<float>(BIT_FLOATS value)
	{
		return value.mValue;
	}
	public List<float>.Enumerator GetEnumerator() { return mValue.GetEnumerator(); }
}