...
{
    unsafe class PooledWindow_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::PooledWindow);
            args = new Type[]{typeof(global::LayoutScript)};
            method = type.GetMethod("setScript", flag, null, args, null);
            app.RegisterCLRMethodRedirection(method, setScript_0);
            args = new Type[]{};
        ...
        static StackObject* setScript_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::LayoutScript @script = (global::LayoutScript)typeof(global::LayoutScript).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
            ...
            instance_of_this_method.setScript(@script);
        ...
        static StackObject* recycle_4(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
            StackObject* ptr_of_this_method;
            StackObject* __ret = ILIntepreter.Minus(__esp, 1);
