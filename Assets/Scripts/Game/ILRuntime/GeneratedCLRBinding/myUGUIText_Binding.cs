...
{
    unsafe class myUGUIText_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::myUGUIText);
        ...
        static StackObject* setText_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            System.Boolean @preferredHeight = ptr_of_this_method->Value == 1;
            ...
            global::myUGUIText instance_of_this_method = (global::myUGUIText)typeof(global::myUGUIText).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
            __intp.Free(ptr_of_this_method);

            instance_of_this_method.setText(@text, @preferredHeight);
