...
namespace ILRuntime.Runtime.Generated
{
    unsafe class FrameBase_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            app.RegisterCLRFieldGetter(field, get_mClassPool_1);
            app.RegisterCLRFieldSetter(field, set_mClassPool_1);
            app.RegisterCLRFieldBinding(field, CopyToStack_mClassPool_1, AssignFromStack_mClassPool_1);
            field = type.GetField("mClassPoolThread", flag);
            app.RegisterCLRFieldGetter(field, get_mClassPoolThread_2);
            app.RegisterCLRFieldSetter(field, set_mClassPoolThread_2);
            app.RegisterCLRFieldBinding(field, CopyToStack_mClassPoolThread_2, AssignFromStack_mClassPoolThread_2);
            field = type.GetField("mGameFramework", flag);
            app.RegisterCLRFieldGetter(field, get_mGameFramework_3);
            app.RegisterCLRFieldSetter(field, set_mGameFramework_3);
            app.RegisterCLRFieldBinding(field, CopyToStack_mGameFramework_3, AssignFromStack_mGameFramework_3);
        ...
        static StackObject* notifyConstructDone_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::FrameBase instance_of_this_method = (global::FrameBase)typeof(global::FrameBase).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack), (CLR.Utils.Extensions.TypeFlags)0);
        ...
        static StackObject* CopyToStack_mEventSystem_0(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static StackObject* AssignFromStack_mEventSystem_0(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static object get_mClassPool_1(ref object o)
        {
            return global::FrameBase.mClassPool;
        }

        static StackObject* CopyToStack_mClassPool_1(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static void set_mClassPool_1(ref object o, object v)
        {
            global::FrameBase.mClassPool = (global::ClassPool)v;
        }

        static StackObject* AssignFromStack_mClassPool_1(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static object get_mClassPoolThread_2(ref object o)
        {
            return global::FrameBase.mClassPoolThread;
        }

        static StackObject* CopyToStack_mClassPoolThread_2(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static void set_mClassPoolThread_2(ref object o, object v)
        {
            global::FrameBase.mClassPoolThread = (global::ClassPoolThread)v;
        }

        static StackObject* AssignFromStack_mClassPoolThread_2(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
        ...
        static object get_mGameFramework_3(ref object o)
        {
            return global::FrameBase.mGameFramework;
        }

        static StackObject* CopyToStack_mGameFramework_3(ref object o, ILIntepreter __intp, StackObject* __ret, IList<object> __mStack)
        {
        ...
        static void set_mGameFramework_3(ref object o, object v)
        {
            global::FrameBase.mGameFramework = (global::GameFramework)v;
        }

        static StackObject* AssignFromStack_mGameFramework_3(ref object o, ILIntepreter __intp, StackObject* ptr_of_this_method, IList<object> __mStack)
        {
            ILRuntime.Runtime.Enviorment.AppDomain __domain = __intp.AppDomain;
