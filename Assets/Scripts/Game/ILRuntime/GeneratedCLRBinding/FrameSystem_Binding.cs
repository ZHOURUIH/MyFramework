...
{
    unsafe class FrameSystem_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            MethodBase method;
            Type[] args;
            Type type = typeof(global::FrameSystem);
            args = new Type[]{};
        ...
        static StackObject* init_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            global::FrameSystem instance_of_this_method = (global::FrameSystem)typeof(global::FrameSystem).CheckCLRTypes(StackObject.ToObject(ptr_of_this_method, __domain, __mStack));
