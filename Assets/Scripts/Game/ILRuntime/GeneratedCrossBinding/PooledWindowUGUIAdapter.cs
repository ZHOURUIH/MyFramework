...
namespace HotFix
{   
    public class PooledWindowUGUIAdapter : CrossBindingAdaptor
    {
        public override Type BaseCLRType
        {
            get
            {
                return typeof(global::PooledWindowUGUI);
            }
        }
        ...
        public class Adapter : global::PooledWindowUGUI, CrossBindingAdaptorType
        {
