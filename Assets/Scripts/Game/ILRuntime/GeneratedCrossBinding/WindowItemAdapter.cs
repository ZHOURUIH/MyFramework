...
{   
    public class WindowItemAdapter : CrossBindingAdaptor
    {
        ...
        static CrossBindingMethodInfo mresetProperty_6 = new CrossBindingMethodInfo("resetProperty");
        ...
        public class Adapter : global::WindowItem, CrossBindingAdaptorType
        {
            ...
            {
                if (mresetProperty_6.CheckShouldInvokeBase(this.instance))
                    base.resetProperty();
                else
                    mresetProperty_6.Invoke(this.instance);
            }
